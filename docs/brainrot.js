...
export const VOCAB = Object.freeze({
  subjects: frozenList([
    ...
    'THE TOKEN ACCOUNTANT', 'YOUR MATH TEACHER', 'THE C64 HEADMASTER',
    'AN UNPAID BENCHMARK INTERN', 'THE ATARI CHESS ENGINE', 'A DISAPPOINTED PARENT',
    'THE CONTEXT WINDOW JANITOR', 'THE 7 PERCENT RECOVERY TEAM'
  ]),
  verbs: frozenList([
    'DELIVERED', 'GYATTED', 'RIZZED UP', 'COOKED', 'AURA-FARMED', 'MEWED AT',
    'SIGMA-MAXED', 'FANUM-TAXED', 'REPOSSESSED', 'BENCHMARKED', 'CONFISCATED',
    'CALCULATED', 'THERMAL-THROTTLED', 'RE-TOKENIZED', 'FAILED UPWARDS',
    'OPENED THE MATH BOOK ON'
  ]),
  objects: frozenList([
    ...
    'YOUR MISSING HOMEWORK', 'THE CONFIDENCE SCORE', 'THE TOKEN BLACK MARKET',
    'THE MATH BOOK', 'YOUR 4KB CHESS OPPONENT', 'THE PERFORMANCE REVIEW',
    'THE LOST CONTEXT WINDOW', 'SEVEN PERCENT OF NOTHING'
  ]),
  fillers: frozenList([
    'NO CAP', 'IN OHIO', 'ON GOD', 'TRUST ME BRO', 'WE GOING UP', 'FULL SEND',
    'BRAINROT DETECTED', 'SO TRUE', 'SHOW YOUR WORK', 'MATH BOOK OPEN', 'NO TED TALK',
    'RUN STOP READY', 'CHEAP TOKENS DETECTED', 'PLEASE STUDY',
    'ARITHMETIC HAS ENTERED CHAT', 'THE SPREAD IS SUS'
  ]),
  verdicts: frozenList([
    'LOCKED IN', 'PERIOD', 'THATS IT', 'STAY MAD', 'END OF DEBATE', 'SO OVER',
    'DO NOT QUESTION IT', 'VERDICT: SKIBIDI', 'GO STUDY', 'RETURN THE 7 PERCENT',
    'C64 WOULD DO BETTER', 'ATARI WANTS A REMATCH', 'AUDIT FAILED SUCCESSFULLY',
    'CONFIDENCE IS NOT A SCORE', 'BOOK OPEN CASE CLOSED', 'READY DOT'
  ]),
  confidences: frozenList([
    ...
    '95% CONFIDENT, 93% CORRECT', 'AUDITED BY COMMODORE 64', 'CALIBRATED BY VIBES',
    '7% PENDING RECOVERY', 'PROVEN BY SPREADSHEET', 'ATARI-VERIFIED*',
    'MATH TEACHER DISAPPROVES', 'TOKENS BOUGHT RETAIL'
  ])
});
